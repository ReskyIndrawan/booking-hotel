      ...
      <div className='grid md:grid-cols-12 gap-5'>
        ...
        <div className='col-span-4 bg-white p-4'>
            ...
            <div className='flex flex-col items-center justify-center text-gray-500 pt-5 pb-6 z-10'>
              ...
              {image ? (
                <button
                  ...
                  <IoTrashBinOutline className='size-5 text-transparent hover:text-white' />
                </button>
              ) : (
          ...
          <button
            type='submit'
            className={clsx(
              "bg-teal-400 text-white w-full hover:bg-teal-500 py-2.5 px-6 md:px-10 text-lg font-semibold cursor-pointer",
              {
